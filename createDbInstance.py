...
if(__name__ == '__main__'):
    ...
    parser.add_argument('--engine', required=True, help='db engine type')
    ...
    parser.add_argument('--user', required=False, help='db username')
    parser.add_argument('--password', required=False, help='db password')
